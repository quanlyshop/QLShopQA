...
namespace QLShopQA {
    ...
    public partial class NhanVien : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NhanVienRow AddNhanVienRow(int MaNV, string TenNhanVien, string GioiTinh, string DiaChi, string SDT, System.DateTime NamSinh) {
...
namespace QLShopQA.NhanVienTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhanVien] ([MaNV], [TenNhanVien], [GioiTinh], [DiaChi], [SDT]," +
                " [NamSinh]) VALUES (@MaNV, @TenNhanVien, @GioiTinh, @DiaChi, @SDT, @NamSinh);\r\nS" +
                "ELECT MaNV, TenNhanVien, GioiTinh, DiaChi, SDT, NamSinh FROM NhanVien WHERE (MaN" +
                "V = @MaNV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [MaNV] = @MaNV, [TenNhanVien] = @TenNhanVien, [GioiTinh] = @GioiTinh, [DiaChi] = @DiaChi, [SDT] = @SDT, [NamSinh] = @NamSinh WHERE (([MaNV] = @Original_MaNV) AND ([TenNhanVien] = @Original_TenNhanVien) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ([SDT] = @Original_SDT) AND ([NamSinh] = @Original_NamSinh));
SELECT MaNV, TenNhanVien, GioiTinh, DiaChi, SDT, NamSinh FROM NhanVien WHERE (MaNV = @MaNV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLShopQA.Properties.Settings.Default.QL_ShopQuanAoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNV, TenNhanVien, GioiTinh, DiaChi, SDT, NamSinh FROM dbo.NhanVien";
        ...
        public virtual int Delete(int Original_MaNV, string Original_TenNhanVien, string Original_GioiTinh, string Original_DiaChi, string Original_SDT, System.DateTime Original_NamSinh) {
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_NamSinh));
        ...
        public virtual int Insert(int MaNV, string TenNhanVien, string GioiTinh, string DiaChi, string SDT, System.DateTime NamSinh) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(NamSinh));
        ...
        public virtual int Update(int MaNV, string TenNhanVien, string GioiTinh, string DiaChi, string SDT, System.DateTime NamSinh, int Original_MaNV, string Original_TenNhanVien, string Original_GioiTinh, string Original_DiaChi, string Original_SDT, System.DateTime Original_NamSinh) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(NamSinh));
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_NamSinh));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenNhanVien, string GioiTinh, string DiaChi, string SDT, System.DateTime NamSinh, int Original_MaNV, string Original_TenNhanVien, string Original_GioiTinh, string Original_DiaChi, string Original_SDT, System.DateTime Original_NamSinh) {
            return this.Update(Original_MaNV, TenNhanVien, GioiTinh, DiaChi, SDT, NamSinh, Original_MaNV, Original_TenNhanVien, Original_GioiTinh, Original_DiaChi, Original_SDT, Original_NamSinh);
        }
    }
